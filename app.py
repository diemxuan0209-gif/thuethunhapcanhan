...
st.write("Tự động tính toán theo biểu thuế 5 bậc và mức giảm trừ gia cảnh mới nhất năm 2026")
...
# --- PHẦN LOGIC TÍNH TOÁN (TỰ ĐỘNG CHẠY, KHÔNG CẦN NÚT BẤM) ---
...
# 2. Giảm trừ gia cảnh luật mới 2026
...
# --- PHẦN HIỂN THỊ KẾT QUẢ KHI CÓ THAY ĐỔI SỐ LIỆU ---
